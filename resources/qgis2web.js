...
map.getView().fit([-773232.375446, 996784.430567, 306291.848214, 1770903.948113], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">POPULATION DE 2006 DES PROVINCES DU BURKINA FASO</h2>';
        return titleElement;
    })(),
